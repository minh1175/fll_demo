...
part of 'tournament_list_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TournamentListResponse _$TournamentListResponseFromJson(
    ...
    TournamentListResponse(
      ...
      how_to_url: json['how_to_url'] as String?,
      create_tournament_url: json['create_tournament_url'] as String?,
      tournament_list: (json['tournament_list'] as List<dynamic>?)
              ?.map((e) =>
                  ItemTourPlayerOrganizer.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    )
...
Map<String, dynamic> _$TournamentListResponseToJson(
        TournamentListResponse instance) =>
    <String, dynamic>{
      'success': instance.success,
      'error_message': instance.error_message,
      'filter_menu_list': instance.filter_menu_list,
      'flg_last_page': instance.flg_last_page,
      'how_to_url': instance.how_to_url,
      'create_tournament_url': instance.create_tournament_url,
      'tournament_list': instance.tournament_list,
    };

ItemTourPlayerOrganizer _$ItemTourPlayerOrganizerFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ItemTourPlayerOrganizerToJson(
        ItemTourPlayerOrganizer instance) =>
    <String, dynamic>{
