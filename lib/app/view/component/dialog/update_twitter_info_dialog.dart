...
void showUpdateTwitterInfoDialog(
    {String? message, String? actionString, VoidCallback? defaultAction}) {
  BuildContext context =
      getIt<NavigationService>().navigatorKey.currentContext!;
  showDialog(
      context: context,
      builder: (BuildContext builderContext) {
        return UpdateTwitterInfoDialog(
          message: message,
...
class UpdateTwitterInfoDialog extends StatelessWidget {
  final String? message;
  final String? actionString;
  VoidCallback? defaultAction;

  UpdateTwitterInfoDialog(
      {Key? key,
